...
module Dice =
    ...
    let rec successfulRoll (fReRollCheck: RerollCheck option) (required: RequiredDiceRoll) (modifier: DiceModifier) (rolledDiceValue: DiceValue) =
